					...
					<checkbox-group @change="checkBoxChange">
						<u-table>
								<u-tr>
									...
									<u-th style="width: 200rpx;flex: 3">订单号</u-th>
								...
								<u-tr v-for="(item, index) in list" :key="index">
									...
									<u-td style="width: 200rpx;overflow: hidden;line-height: 21px;flex: 3">{{ item.SO_ORDER }}</u-td>
...
<script src="./OfflineOperations2.js">
</script>
