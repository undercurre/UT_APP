	...
	<gracePage :customHeader="true">
		<graceHeader slot="gHeader" background="#009c50">
			<view class="grace-header-body">
				...
				<!-- 中间内容 -->
				<view class="grace-header-content-noflex main-tit"><text class="grace-white" style="font-size: 38rpx;">栈板扫码</text></view>
			</view>
		</graceHeader>
		<view slot="gBody" class="grace-body">
			<view class="form-content">
				...
				<view class="form-item">
					...
					<view class="form-value">
						<input class="form-input" :maxlength="-1" type="text" v-model="Pallet_NO" placeholder=" " :focus="autoFocus" :disabled="true">
					</view>
				</view>
				<view class="form-item">
					<view class="form-label align-right">
...
<script src="./PalletSweep.js"></script>
