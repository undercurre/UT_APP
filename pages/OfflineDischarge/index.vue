	...
	<gracePage :customHeader="true">
		<graceHeader slot="gHeader" background="#009c50">
			<view class="grace-header-body">
				...
				<!-- 中间内容 -->
				<view class="grace-header-content-noflex main-tit"><text class="grace-white" style="font-size: 38rpx;">离线卸料</text></view>
			</view>
		</graceHeader>
			...
			<view class="form-content">
				<view class="form-item" style="margin-bottom: 0;">
					...
					<view class="form-value">
						<input class="form-input" :maxlength="-1" type="text" v-model="formData.feederOrReel" placeholder=" " :focus="autoFocus"
						 @confirm="handleBlur">
					</view>
				</view>
				<!-- 消息区 -->
...
<script src="./OfflineDischarge.js">
</script>
