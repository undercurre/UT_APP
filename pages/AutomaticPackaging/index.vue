	...
	<gracePage :customHeader="true">
		<graceHeader slot="gHeader" background="#009c50">
			<view class="grace-header-body">
				...
				<!-- 中间内容 -->
				<view class="grace-header-content-noflex main-tit"><text class="grace-white" style="font-size: 38rpx;">自动包装过站</text></view>
			</view>
		</graceHeader>
		<view slot="gBody" class="grace-body">
			<view class="form-content">
				...
				<view class="form-item">
					...
					<view class="form-value">
						<input class="form-input" :maxlength="-1" type="text" v-model="Carton_NO" placeholder=" " :focus="autoFocus" :disabled="true">
					</view>
				</view>
				<view class="form-item">
					<view class="form-label align-right">
					...
					<view class="form-value">
						<input class="form-input" :maxlength="-1" type="text" v-model="DefinedQty" placeholder=" " :focus="autoFocus">
					</view>
				</view>
				<view class="form-item">
					<view class="form-label align-right">
					...
					<view class="form-value">
						<input class="form-input" :maxlength="-1" type="text" v-model="CurrentQty" placeholder=" " :focus="autoFocus" :disabled="true">
					</view>
					<view class="toolbar-btn primary full-but" @tap="FullClick">
						<text class="tix">置满</text>
					</view>
				</view>
			</view>
...
<script src="./AutomaticPackaging.js"></script>
