			...
			<view class="form-content">
				<div id="myForm">
						...
						<view class="form-value">
							<picker mode="selector" :range="defectCodeList" range-key="DESCRIPTION" @change="handleChangeDefectCode">
								<div class="picker-s">
									...
									}" :value="defectCodeList[defectCodeIndex] ? defectCodeList[defectCodeIndex].DESCRIPTION : ''" placeholder=" ">
					...
					<view class="form-item">
						...
						<view class="form-value">
							<picker mode="selector" :range="lineList" range-key="LINE_NAME" @change="handleFilterLine">
								<div class="picker-s">
									<input class="form-input" disabled type="text" :style="{
										color: lineList[lineIndex] ? '#333' : 'rgb(158, 158, 158)'
									}" :value="lineList[lineIndex] ? lineList[lineIndex].LINE_NAME : ''" placeholder=" ">
									<text class="grace-select-menu-icon icon-allow-b"></text>
								</div>
							</picker>
						</view>
...
<script src="./feidaRepair.js"></script>
