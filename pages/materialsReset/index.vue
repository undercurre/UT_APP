	...
	<gracePage :customHeader="true">
		<graceHeader slot="gHeader" background="#009c50" ref="header">
			<view class="grace-header-body">
				...
				<!-- 中间内容 -->
				<view class="grace-header-content-noflex main-tit"><text class="grace-white" style="font-size: 38rpx;">对料结果重置</text></view>
			</view>
		</graceHeader>
		<view slot="gBody" class="grace-body">
			<view class="insTop">
				<view class="insX"><text class="insT">机台名称</text></view>
			</view>
			<view class="grace-form mysticky">
				...
				>
					<view class="mycell" v-for="(item, index) in list" :key="index">
						<view class="x-list">
							<checkbox-group style="width: auto;" @change="handleCheck($event, item)">
...
<script src="./materialsReset.js"></script>
