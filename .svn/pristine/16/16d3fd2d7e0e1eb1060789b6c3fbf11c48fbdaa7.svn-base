<template>
	<view class="grace-nowrap grace-flex-vcenter" :style="{width:width,justifyContent: justifyContent}" @tap.stop="changeStatus">
		<view 
...
.grace-check-lable{color:#555555; margin-left:20rpx; font-size:26rpx; width:auto;}
</style>