		...
		<gracePage :customHeader="true">
			<graceHeader slot="gHeader" background="#009c50">
				<view class="grace-header-body">
					...
					<!-- 中间内容 -->
					<view class="grace-header-content-noflex main-tit"><text class="grace-white" style="font-size: 38rpx;">设备保养计划</text></view>
				</view>
			</graceHeader>
			<view slot="gBody" class="grace-body">
				...
				<view class="list-block" :style="{
					...
					<view class="item-block" v-for="(item,index) in LoadData" :key="index" @tap="handleToDetails(item,index)" :style="{border: index === ListIndex ? '2rpx solid #1890FF' : '2rpx solid transparent'}">
						<view class="item-info" style="border-bottom: 1px solid #E3E3E3;">
							<view class="info-Numbering">
								盘点编号：{{item.CHECK_CODE}}
							</view>
