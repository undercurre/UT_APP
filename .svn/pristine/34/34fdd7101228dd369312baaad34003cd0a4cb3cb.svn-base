<template>
	<view class="grace-number-box" :style="{width:width,height: '60rpx!important',marginTop: '0!importantr'}">
...
.grace-number-box-input{text-align:center; width:150rpx;height: 60rpx;line-height: 1!important;}
</style>