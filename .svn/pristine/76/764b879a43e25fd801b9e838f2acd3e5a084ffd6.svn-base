	...
	<gracePage :customHeader="true">
		<graceHeader slot="gHeader" background="#009c50">
			<view class="grace-header-body">
				...
				<!-- 中间内容 -->
				<view class="grace-header-content-noflex main-tit"><text class="grace-white" style="font-size: 38rpx;">接料</text></view>
			</view>
		</graceHeader>
			...
			<view class="form-content">
				<view class="form-item">
					...
					<view class="form-value">
						<input class="form-input" type="text" :maxlength="-1" :value="formData.newReelID" placeholder=" " :focus="autoFocus" @confirm="handleCheckReel"></input>
					</view>
				</view>
				<view class="form-item" style="margin-bottom: 0;">
					...
					<view class="form-value">
						<input class="form-input" :maxlength="-1" type="text" :value="formData.feederReelLocation" placeholder=" " :focus="checkReelFlag" @confirm="handleConnectReel"></input>
					</view>
				</view>
				<!-- 消息区 -->
				<div class="titX">
...
<script src="./connectReel.js"></script>
