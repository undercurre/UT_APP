<template name="graceFullLoading">
	<view class="grace-full-loading" v-if="graceFullLoading" @tap.stop="stopFun" @touchmove.stop="stopFun">
		<view class="content">
			<view class="image"><image class="img" :src="logoUrl" mode="widthFix" :style="{ width: size, height: size }"></image></view>
...
.grace-full-loading .image {
	text-align: center;
	font-size: 0;
}
.grace-full-loading .image .img {
	width: 138rpx;
	height: 138rpx;
	border-radius: 100%;
}
