<template>
	<view class="grace-nowrap grace-flex-vcenter" @tap.stop="changeStatus">
		<text v-if="status" class="grace-check-btn grace-icons" :style="{fontSize:size+'rpx', lineHeight:size + 2+'rpx', color : checkedColor}">&#xe7f8;</text>
		<text v-else class="grace-check-btn grace-icons" :style="{fontSize:size+'rpx', lineHeight:size + 2 +'rpx', color : color}">&#xe762;</text>
